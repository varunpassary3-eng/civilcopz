  ...
  <div class="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
    ...
    <header class="relative p-12 bg-indigo-900 rounded-[3rem] overflow-hidden shadow-2xl">
      ...
      <div class="relative z-10 space-y-4">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-indigo-400">
          <span class="w-2 h-2 bg-indigo-400 rounded-full animate-pulse" />
        ...
        <h2 class="text-5xl font-black tracking-tighter text-white leading-none">
          THE CONSUMER<br><span class="text-gov-primary-400">PROTECTION PROTOCOL</span>
        </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div
        ...
        :key="section.id"
        class="group p-8 bg-white dark:bg-gov-dark-900 border border-slate-200 dark:border-gov-dark-800 rounded-[2.5rem] shadow-xl hover:-translate-y-2 transition-all duration-300"
      >
        ...
        <h3 class="text-xl font-black text-slate-900 dark:text-white mb-4 group-hover:text-gov-primary-600 transition-colors">
          {{ section.title }}
        </h3>
        ...
        <div class="pt-6 border-t border-slate-100 dark:border-gov-dark-800 flex items-center justify-between">
          <button class="text-[10px] font-black uppercase tracking-widest text-gov-primary-600 hover:underline">
            Full Legal Text
          </button>
    ...
    <div class="p-8 border-2 border-slate-200 dark:border-gov-dark-800 rounded-3xl bg-slate-50 dark:bg-gov-dark-950/40">
      <p class="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-2">
        Legal Disclaimer: Policy Hub Protocol
      </p>
