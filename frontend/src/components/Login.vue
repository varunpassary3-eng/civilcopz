  ...
  <div class="max-w-md mx-auto mt-20 p-8 pt-10 relative">
    ...
    <div class="backdrop-blur-xl bg-white/80 dark:bg-gov-dark-900/90 border border-white/20 dark:border-gov-dark-800/50 p-8 rounded-3xl shadow-2xl">
      <div class="text-center mb-10">
        ...
        <h2 class="text-3xl font-black tracking-tighter text-slate-900 dark:text-white uppercase mb-2">Personnel Access</h2>
        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Secure Directorate Authentication</p>
      </div>
      ...
      <div class="mt-8 pt-6 border-t border-slate-100 dark:border-gov-dark-800 text-center">
        <p class="text-xs text-slate-500 font-bold uppercase tracking-tight">
          New to the Bureau? 
          <router-link to="/register" class="text-gov-primary-600 hover:text-gov-primary-700 underline decoration-2 underline-offset-4">Register Personnel</router-link>
        </p>
      </div>
